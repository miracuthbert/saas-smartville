...
@section('title', page_title('Rent Invoices'))
...
@section('tenant.content')
        ...
        <div class="card-body">
            <div class="card-title">
                <div class="d-flex justify-content-between align-content-center">
                    ...
                    <aside>
                        <div class="btn-group">
                            <a href="{{ route('tenant.rent.invoices.create') }}" class="btn btn-link">
                                Add Invoice
                            </a>
                            <!-- Filters link -->
                            ...
                            <div class="btn-group">
                                <div class="btn-group dropdown" role="group">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="{{ route('tenant.rent.invoices.reports.download', array_except(request()->query(), 'page')) }}"
                                           class="dropdown-item">
                                        ...
                                        <a href="{{ route('tenant.rent.invoices.reports.download') }}"
                                           class="dropdown-item">
                                            All
                                        </a>
                                    </div>
            ...
            {{-- Filters --}}
            @include('tenant.rent.partials._filters')
        </div>
    </div>
        ...
        <div class="table-responsive-sm mb-3">
            <table class="table table-hover table-outline mb-0">
                ...
                <tr>
                    ...
                    <th>
                        <span data-toggle="tooltip" title="Taken and calculated from the property price">
                            Amount <i class="icon-info"></i>
                        </span>
                    </th>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a class="btn btn-link" role="button"
                                   href="{{ route('tenant.rent.invoices.edit', $invoice) }}">
                                    <i class="fa fa-edit"></i> <span class="sr-only">Edit</span>
                                </a>
                                <!-- Delete Button -->
                                <a class="nav-link text-danger" role="button"
                                   href="{{ route('tenant.rent.invoices.destroy', $invoice) }}"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right"
                                        ...
                                        @if(!$invoice->cleared_at)
                                            <a class="dropdown-item"
                                               href="{{ route('tenant.rent.invoices.clear', $invoice) }}">
                                                Issue Receipt
                                            </a>
                                            <a href="{{ route('tenant.rent.invoices.remind', $invoice) }}"
                                               class="dropdown-item">
                                                Send reminder
                                            </a>
                                        @endif
                                        ...
                                        <a href="{{ route('tenant.rent.invoices.preview', $invoice) }}"
                                           class="dropdown-item"
                                           target="_blank">
                                            Preview Invoice
                                        </a>
                            ...
                            {{-- Delete Form --}}
                            <form action="{{ route('tenant.rent.invoices.destroy', $invoice) }}" method="POST"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Generate Rent Report</h5>
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <form action="{{ route('tenant.rent.invoices.reports.download') }}" id="reportsForm">
    ...
    @else
        <div class="media">
            <div class="media-body">No invoices found.</div>
        </div>
    @endif
@endsection
