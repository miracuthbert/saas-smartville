                ...
                <div class="form-group row{{ $errors->has('overview') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="overview"
                               ...
                               value="{{ old('overview', $feature->overview) }}" maxlength="160" required>
                ...
                <div class="form-group row{{ $errors->has('description') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <textarea name="description" id="description" rows="5"
                                  class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}">{{ old('description', $feature->description) }}</textarea>
                ...
                <div class="form-group row{{ $errors->has('usable') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <select name="usable" id="usable"
                            ...
                            <option value="0"{{ old('usable', $feature->usable) == 0 ? ' selected' : '' }}>Disable
                            </option>
                            <option value="1"{{ old('usable', $feature->usable) == 1 ? ' selected' : '' }}>Active
                            </option>
                        </select>
