...
class UtilityInvoiceCleared extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject("{$this->utility->name} Payment & Clearance")
            ->markdown('tenant.emails.utilities.invoice.cleared', [
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'title' => "{$this->property->name}, {$this->utility->name} Payment Cleared",
        ];
    }
}
