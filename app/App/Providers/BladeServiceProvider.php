...
class BladeServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Blade::component('components._datepicker', 'datepicker');
        
        // datetimepicker component
        Blade::component('components._datetimepicker', 'datetimepicker');

        // selectedfilters component
        Blade::component('components.filters._selected_filters', 'selectedfilters');
    }
