...
class AssignUserRoleCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'role:assign {email} 
                {--role= : The slug of the role to be assigned.} 
                {--days : The number of days after which role will be revoked from user.}';
     ...
     * @var string
     */
    protected $description = 'Assign user a role by passing in their email and role';
