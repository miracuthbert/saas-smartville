...
class PermissionController extends Controller
{
    ...
    {
        $permissions = Permission::with('roles', 'companyRoles')->latest()->paginate();
    ...
    {
        Permission::create($request->only(['name', 'for_company', 'usable']));
    ...
    {
        $permission->fill($request->only(['name', 'for_company', 'usable']));
    ...
    {
        if (!$permission->roles->count() || !$permission->companyRoles->count()) {
            $permission->delete();
